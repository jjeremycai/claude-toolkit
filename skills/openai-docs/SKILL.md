...
If MCP tools fail or no OpenAI docs resources are available, ask the user to configure the OpenAI Developer Docs MCP server (`https://developers.openai.com/mcp`) in their settings and restart their session.
