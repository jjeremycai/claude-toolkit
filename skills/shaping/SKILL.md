...
| **Breadboarding** | Map selected shape into concrete affordances and wiring | Affordance tables (UI, Code, Data stores), optional Mermaid diagram |
| **Slicing** | Break breadboarded shape into vertical implementation increments | Vertical slices with demo-able UI |
...
| **F2** | Magic authentication handler | flagged |
