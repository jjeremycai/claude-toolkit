---
description: Audit code changes with @code-reviewer subagents
argument-hint: [pr-url-or-number] [--verify]
agent: plan
allowed-tools: Bash, Read, Grep, Glob, Task, WebFetch, AskUserQuestion, Skill, mcp__claude-in-chrome__*, mcp__claude_ai_Context7__resolve-library-id, mcp__claude_ai_Context7__query-docs
---
